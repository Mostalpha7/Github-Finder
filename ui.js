        ...
        repos.forEach(item => {
            ...
            <div class="card card-body mb-2">
                <div class="row">
                    ...
                    <div class="col-md-6">
                        <span class="badge badge-primary">Stars:${item.stargazers_count}
                        </span>
                        <span class="badge badge-primary">Watchers: ${item.watchers_count}
                        </span>
                        <span class="badge badge-primary">Forks: ${item.forms_count}
                        </span>
                    </div>
                </div>
            </div>
